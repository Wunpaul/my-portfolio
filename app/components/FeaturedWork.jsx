    ...
    <section id="work" className="py-20 px-6 max-w-5xl mx-auto scroll-mt-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-20 items-center">
        ...
        <div className="md:col-span-5 flex flex-col md:items-end md:text-right z-10">
          ...
          {/* ACTION AREA WITH CASE STUDY BUTTON */}
          <div className="flex items-center gap-5 md:justify-end mt-2">
            <Link 
                href="/projects/smart-chama" 
                className="px-5 py-2 bg-blue-600 text-white rounded-md font-bold text-sm shadow-sm hover:bg-blue-700 transition-colors"
            >
                Read Case Study
            </Link>
            
            <div className="flex gap-4 border-l border-slate-300 pl-5">
