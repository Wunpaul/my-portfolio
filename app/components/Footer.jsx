    ...
    <footer className="bg-slate-900 text-slate-300 py-12">
      <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="text-center md:text-left">
          <span className="font-bold text-white text-lg block mb-1">Johnpaul.dev</span>
          <p className="text-slate-400 text-sm">
            © {new Date().getFullYear()} Johnpaul Owino. All rights reserved.
          </p>
        </div>
        ...
        <div className="flex gap-6 items-center">
          ...
          {/* LinkedIn Icon */}
          <a 
            href="https://www.linkedin.com/in/johnpaul-owino-b43a07428/" 
            target="_blank"
            rel="noopener noreferrer"
            className="text-slate-400 hover:text-orange-500 transition-colors duration-300"
            aria-label="LinkedIn"
